...
public class Matrix4f {
	...
	public Matrix4f initScaling(Vector3f scaling){
	...
	public Matrix4f initProjection(float fov, float width, float height, float zNear, float zFar){
		...
		m[0][0] = x_scale;	m[0][1] = 0;		m[0][2] = 0;									m[0][3] = 0;
		m[1][0] = 0;		m[1][1] = y_scale;	m[1][2] = 0;									m[1][3] = 0;
		m[2][0] = 0;		m[2][1] = 0;		m[2][2] = -((zFar + zNear) / frustum_length);	m[2][3] = -((2 * zNear * zFar) / frustum_length);
