        ...
        try {
            ...
            while ((line = reader.readLine()) != null) {
                ...
                if(tokens[0].equals("#") || tokens[0].equals("o") || tokens[0].equals("s")){
                    ...
                    Vec3f vertex = new Vec3f(Float.parseFloat(tokens[1]),
                            Float.parseFloat(tokens[2]), Float.parseFloat(tokens[3]));
                    vertices.add(vertex);
                } else if (tokens[0].equals("vt")) {
                    Vec2f texture = new Vec2f(Float.parseFloat(tokens[1]),
                            Float.parseFloat(tokens[2]));
                    textures.add(texture);
                } else if (tokens[0].equals("vn")) {
                    Vec3f normal = new Vec3f(Float.parseFloat(tokens[1]),
                            Float.parseFloat(tokens[2]), Float.parseFloat(tokens[3]));
                    normals.add(normal);
            ...
            for(String[] face : faces){
                ...
                Vec2f texture = new Vec2f(textures.get(currentTexture).getX(), 1 - textures.get(currentTexture).getY());
