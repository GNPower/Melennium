...
public class Input {
	...
	protected Input() {
		...
		lockedCursorPosition = new Vector2f();
	...
	public void setCursorPosition(int x, int y) {
		this.cursorPosition = new Vector2f(x, y);
	...
	public void setLockedCursorPosition(Vector2f position) {
		this.lockedCursorPosition = position;
	}
	
	public void setLockedCursorPosition(int x, int y) {
		this.lockedCursorPosition = new Vector2f(x, y);
	}
